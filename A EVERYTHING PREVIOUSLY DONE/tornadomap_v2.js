...
function createMap(data) {
  ...
  // Check if layerControl exists, and if it does, remove it from the map
  if (layerControl) {
    layerControl.remove();
  }
  ...
  // Reassign layerControl with the updated overlays
  layerControl = L.control.layers(null, overlays, {collapsed: false});

  // Add the updated layerControl back to the map
